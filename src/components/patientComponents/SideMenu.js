...
function SideMenu(props) {
  ...
  return (
    <div
      className="_Side__menu"
      style={{
        transform: `translateX(${props.showSideMenu ? "0%" : "-100%"})`,
      }}
    >
      <button
        className="_side_menu_close"
      ...
      <div className="_top">
        ...
        <div className="side_menu_profile">
...
const mapStateToProps = (state) => ({
  showSideMenu: state.toggleSideMenuState.sideMenuShow,
});
